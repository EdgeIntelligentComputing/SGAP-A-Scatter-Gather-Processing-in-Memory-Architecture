...
double app_mul(int a,int b,int m){
	...
	//MSE
	double diff=abs((double)(sum/num)-(double)c/num);
	ed=diff*diff/(double)num/(double)num;
	
	//if(m<=3)
	//printf("%2d %2d %2d %d %d %d %lf %lf\n",a,b,m,sum,sum/num*num,c,diff,ed);
	//printf("%lf\n",ed);
	return ed;
}
...
//			
//			//mse binary
//			double diff=(double)(i*j/num)-(double)(i*j)/num;
//			double ex_mse=diff*diff/(double)num/(double)num;
//			ex_sum+=ex_mse;
//			//printf("%d %d %lf\n",i,j,ex_mse);
//			
//			//Sprintf("%d %d a:%lf b:%lf diff:%lf %lf\n",i,j,(double)(i*j/num),(double)(i*j)/num,diff,ex_mse);
//			
//			//med binary
//			//double ex_p=(abs(i*j/num-(double)(i*j)/num)/(double)num);
//			//ex_sum+=ex_p;
//		
//			//printf("%d %d %lf\n",i,j,ex_p);
//		}
