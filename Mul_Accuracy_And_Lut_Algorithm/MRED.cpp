...
//exact computing     binary
//	for(int i=0;i<num;i++){
//		for(int j=0;j<num;j++){
//			//ex_precision = exact_mul(i,j);
//			
//			//mred binary
//			double exact=(double)(i*j)/num;
//			double diff=abs((double)(i*j/num)-exact);
//			double ex_mred;
//			if(exact==0){
//				ex_mred=0;
//			}else{
...
//			ex_sum+=ex_mred;
//			
//			//printf("%d %d a:%lf b:%lf diff:%lf %lf\n",i,j,(double)(i*j/num),(double)(i*j)/num,diff,ex_mred);
//			
//			//med binary
