...
REM
REM Generated by Vivado on Tue Jul 18 15:53:19 +0800 2023
...
echo "xvlog --incr --relax -prj main_bench_vlog.prj"
call xvlog  --incr --relax -prj main_bench_vlog.prj -log xvlog.log
